...
------------------------------------
    ...
    if not containerInvestissement then
	    ...
	    titleContainerInvestissement:SetFont(titletext):SetDefaultColor(60,35,23,255):SetText("Points par Durée (Mois)"):Center():SetY(14)
	end
...
-------------------------------------------------------------------------
		...
		if not containerInvestissement2 then
	    	...
	    	titleContainerInvestissement2:SetFont(titletext):SetDefaultColor(60,35,23,255):SetText("Points par Montant (Millions F)"):Center():SetY(214)
	 	end
...
-------------------------------------------------------------------------
    ...
    tabsmenudown:AddTab("Créditeurs", panel2, "Créditeurs")
	    ...
	    if not containerInvestissement then
		    ...
		    titleContainerInvestissement:SetFont(titletext):SetDefaultColor(60,35,23,255):SetText("Revenus Annuels Brut (k F)"):Center():SetY(14)
		end
	...
	-------------------------------------------------------------------------
			...
			if not containerInvestissement2 then
		    	...
		    	titleContainerInvestissement2:SetFont(titletext):SetDefaultColor(60,35,23,255):SetText("Durée de Remboursement (Années)"):Center():SetY(204)
		 	end
	...
	-------------------------------------------------------------------------
			...
			if not containerInvestissement2 then
		    	...
		    	containerInvestissement2:SetImage("ressources/UiRackMenuBlock.png"):SetScale(0.55,0.43):Center():SetY(390)
		   		local titleContainerInvestissement2 = loveframes.Create("text", panel2)
		    	titleContainerInvestissement2:SetFont(titletext):SetDefaultColor(60,35,23,255):SetText("Montant du Crédit (k F)"):Center():SetY(394)
		 	end
			...
			local textboxRemuneration4 = loveframes.Create("textinput", panel2)
				textboxRemuneration4:SetWidth(50)
				textboxRemuneration4:SetPos(18+12,532):SetValue(tostring(minimalCrediteurAskBehoof or 0))
				textboxRemuneration4.OnEnter = function(object,text)
		   ...
		   local slider6 = loveframes.Create("slider", panel2)
			...
			slider6:SetPos(-30000, -14000)
			slider6:SetWidth(370)
    ...
    tabsmenudown:AddTab("Personel", panel4, "Personel")
	    ...
	    titleContainerPersonnel:SetFont(titletext):SetDefaultColor(60,35,23,255):SetText("Détail de l'effectif"):Center():SetY(14)
	    local detailsTextPersonnel = loveframes.Create("text", panel4)
	    detailsTextPersonnel:SetFont(date_box_text2):SetPos(10,52):SetDefaultColor(0,0,0,255):SetText("  Employés\t\tSalaire Brut (F)\t  Coût Total des Salariés (F)")
	    local detailsTextPersonnel2 = loveframes.Create("text", panel4)
	    detailsTextPersonnel2:SetDefaultColor(0,0,0,255):SetText("/mois\t\t\t\t\t\t\t\t\t/mois\n\n\n/an\t\t\t\t\t\t\t\t\t\t/an"):SetPos(180,92)
	    ...
	    titleContainerPersonnel2:SetFont(titletext):SetDefaultColor(60,35,23,255):SetText("Gestion de l'effectif"):Center():SetY(194)
	    ...
	    clickablePersonnel2:SetImage("ressources/UiBtnFixed.png"):SetPos(110,240):SizeToImage():SetText("Modifier le nombre d'employés")
	    ...
	    clickablePersonnel3:SetImage("ressources/UiBtnFixed.png"):SetPos(110,430):SizeToImage():SetText("Modifier les salaires")
    ...
    tabsmenudown:AddTab("Publicité", panel5, "Publicité")
    	...
    	if not containerPublicite then
		    ...
		    titleContainerPublicite:SetFont(titletext):SetDefaultColor(60,35,23,255):SetText("Produits publicitaires"):Center():SetY(14)
		end
