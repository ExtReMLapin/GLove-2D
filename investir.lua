...
function investisseurMenu()
	...
	sliderForm1:SetPos(35, 130):SetSize(315, 200):SetName("Maturité (durée d'investissement)")
		...
		courtTerme:SetText("Court terme:"):SetPos(45, 175)
		...
		moyenTerme:SetText("Moyen terme:"):SetPos(45, 225)
		...
		longTerme:SetText("Long terme:"):SetPos(45, 275)
	...
	sliderForm2:SetPos(390, 130):SetSize(315, 200):SetName("Somme investie")
		...
		faibleInvest:SetText("Faible invest. :"):SetPos(400,175)
		...
		moyenInvest:SetText("Moyen invest. :"):SetPos(400,225)
		...
		fortInvest:SetText("Fort invest. :"):SetPos(400,275)
