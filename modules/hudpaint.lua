...
hook.Add("SaveRestored", "MoneyMonthDrawsave",function () 
	hook.Add("DrawOverFrame", "MoneyMonthDraw",function () 
		...
		love.graphics.setColor(0,0,0)
		love.graphics.setFont( date_box_text1 )
		love.graphics.print("Revenus  Mensuels : ".. monthlyEarning.."F", 190 + xoffset - date_box_text1:getWidth("Revenus  Mensuels :") , yoffset + 17)
		love.graphics.print("Annuels : ", 190 + xoffset - date_box_text1:getWidth("Annuels :"), yoffset + 35)
		love.graphics.print("Frais  Mensuels : ".. Salary*nbEmployees.. "F", 190 + xoffset - date_box_text1:getWidth("Frais  Mensuels :") , yoffset + 58)
		love.graphics.print("Annuels : ".. annualPayment.. "F", 190 + xoffset - date_box_text1:getWidth("Annuels :"), yoffset + 76)
